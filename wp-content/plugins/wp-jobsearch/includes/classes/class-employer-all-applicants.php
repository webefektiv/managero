            ...
            if ($employer_id > 0) {
                ...
                <div class="jobsearch-typo-wrap">
                    <div class="jobsearch-employer-box-section">
                        <div class="jobsearch-profile-title"><h2><?php esc_html_e('All Applicants', 'wp-jobsearch') ?></h2></div>
                            ...
                            <div class="select-appsjob-con">
                                ...
                                <div class="overall-appcreds-con">
                                    <ul>
                                        ...
                                        <li><span class="res-apps"><?php esc_html_e('Rezerve ', 'wp-jobsearch') ?></span><div class="applicnt-count-box res-apps"> <a class="overall-site-resaplicnts">0</a></div></li>
        ...
        public static function list_job_all_apps($_job_id, $employer_id, $apps_start = 0) {
            ...
            if (!empty($job_applicants_list)) { ?>
                    ...
                    <div class="jobsearch-candidati-list">
                        ...
                        <div class="jobsearch-table-layer jobsearch-managejobs-thead">
                            <div class="jobsearch-table-row">
                                <div class="jobsearch-table-cell">Nume</div>
                                <div class="jobsearch-table-cell">Varsta</div>
                                <div class="jobsearch-table-cell">Sex</div>
                                <div class="jobsearch-table-cell">Companie</div>
                                <div class="jobsearch-table-cell">Job</div>
                                <div class="jobsearch-table-cell">Salariu</div>
                ...
                foreach ($job_applicants_list as $_candidate_id) {
	                ...
	                $candidate_prenume       = get_post_meta( $_candidate_id, 'preunume', true );
	                $candidate_nume          = get_post_meta( $_candidate_id, 'nume', true );
	                $candidate_particula     = get_post_meta( $_candidate_id, 'cuv_legatura', true );
	                $candidate_formula       = get_post_meta( $_candidate_id, 'formula_de_adresare', true );
	                $candidate_titluacademic = get_post_meta( $_candidate_id, 'titlu_academic', true );
	                $candidate_nickname      = get_post_meta( $_candidate_id, 'nickname', true );
	                $candidat_fullname       = $candidate_titluacademic . " " . $candidate_prenume;
	                if ( $candidate_particula != '' && $candidate_particula != '-' ) {
		                $candidat_fullname .= ' ' . $candidate_particula;
	                }
	                $candidat_fullname .= ' ' . $candidate_nume;

	                $salariu     = get_post_meta( $_candidate_id, 'salariu_minim', true );
	                $sex         = get_post_meta( $_candidate_id, 'sex', true );
	                $companie    = get_post_meta( $_candidate_id, 'companie_ultimul_job', true );
	                $ultimul_job = get_post_meta( $_candidate_id, 'ultimul_job_cadidat', true );
                    ...
                    <li class="jobsearch-column-12">
                        ...
                        <div class="jobsearch-table-layer jobsearch-managejobs-tbody manage2">
                            <div class="jobsearch-table-row">
                                <div class="jobsearch-table-cell">
                                    ...
                                    <h6 class="numeCand">
                                        <a href="<?php echo get_permalink( $_candidate_id ) ?>"> <?= $candidat_fullname; ?></a>
                                    </h6>


                                </div>
                                <div class="jobsearch-table-cell">
					                <?php echo apply_filters( 'jobsearch_dash_applicants_age_html', sprintf( esc_html__( '%s ani', 'wp-jobsearch' ), $candidate_age ) ) ?>
                                </div>
										                ...
										                if ( $multiple_cv_files_allow == 'on' ) {
                                                            ...
                                                            <li>
                                                                <a href="<?php echo( $file_url ) ?>"
                                                                   download="<?php echo( $cv_file_title ) ?>"><?php esc_html_e( 'Download CV', 'wp-jobsearch' ) ?></a>
                                                            </li>
											                <?php
										                }
...
<!--                                                        email candidat zona toti aplicantii-->
                                                        <li style="display: none">
											                ...
											                $popup_args = array(
												                ...
												                'p_emp_id'    => $employer_id,
												                'p_masg_rand' => $send_message_form_rand
											                );
										                ...
										                if ( in_array( $_candidate_id, $job_reject_int_list ) ) {
                                                            ...
                                                            <li>
												                ...
												                if ( in_array( $_candidate_id, $job_reserved_int_list ) ) {
													                ?>
                                                                    <a href="javascript:void(0);"
                                                                       class="reserved-cand-to-intrview"><?php esc_html_e( 'Candidat rezervat', 'wp-jobsearch' ) ?></a>
													                <?php
												                } else {
													                ?>
                                                                    <a href="javascript:void(0);"
                                                                       class="reserved-cand-to-intrview ajax-enable"
                                                                       data-jid="<?php echo absint( $_job_id ); ?>"
                                                                       data-cid="<?php echo absint( $_candidate_id ); ?>"><?php esc_html_e( 'Adauga la rezerve', 'wp-jobsearch' ) ?>
                                                                        <span class="app-loader"></span></a>
													                <?php
												                }
												                ?>
        ...
        public static function load_wapp_jobs_posts($jobs_posts, $employer_id) {
            if (!empty($jobs_posts)) {
                foreach ($jobs_posts as $_job_id) {
                    ...
                    <div class="sjob-aplicants-list aiciecall">
                        <div class="thjob-title">
                            ...
                            <div class="total-appcreds-con">
                                <ul>
                                    ...
                                    <li><div class="applicnt-count-box res-apps"><span><?php esc_html_e('Rezerve', 'wp-jobsearch') ?></span> <?php echo absint($job_reserved_int_list_c) ?></div></li>
        ...
        public function alljobs_apps_count_loadboxes() {
            ...
            $appcounts = $shappcounts = $rejappcounts = $resappcounts = 0;
            ...
            if (!empty($jobs_posts)) {
                foreach ($jobs_posts as $_job_id) {
	                ...
	                $job_reserved_int_list = jobsearch_is_post_ids_array($job_reserved_int_list, 'candidate');
	                $job_reserved_int_list_c = !empty($job_reserved_int_list) ? count($job_reserved_int_list) : 0;
	                $resappcounts += $job_reserved_int_list_c;
            ...
            echo json_encode(array('appcounts' => $appcounts, 'shappcounts' => $shappcounts, 'rejappcounts' => $rejappcounts,  'resappcounts' => $resappcounts));
