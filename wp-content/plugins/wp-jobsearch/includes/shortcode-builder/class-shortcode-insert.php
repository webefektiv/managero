            ...
            switch ($jobsearch_builder_param['type']) {
                ...
                case 'multi_checkbox' :
                    ...
                    foreach ($jobsearch_builder_param['options'] as $jobsearch_builder_value => $jobsearch_builder_option) {
                        ...
                        $jobsearch_builder_output .= '<div class="onechnbox-con"><input type="checkbox" name="' . $jobsearch_builder_key . '" id="' . $jobsearch_builder_key . $rand_num . '" value="' . $jobsearch_builder_value . '" class="jobsearch-builder-form-checkbox jobsearch-builder-input">';
                        $jobsearch_builder_output .= '<label for="' . $jobsearch_builder_key . $rand_num . '">' . $jobsearch_builder_option . '</label></div>' . "\n";
                    }
                    $jobsearch_builder_output .= '<span class="jobsearch-builder-form-desc">' . $jobsearch_builder_param['desc'] . '</span></td>';
