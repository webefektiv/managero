...
if (!class_exists('jobsearch_all_applicants_handle')) {
    ...
    class jobsearch_all_applicants_handle {
                                    ...
                                    <ul>
                                        ...
                                        if ($multiple_cv_files_allow == 'on') {
                                            ...
                                            if (!empty($ca_at_cv_files)) {
                                                ?>
                                                <li><a href="<?php echo apply_filters('jobsearch_user_attach_cv_file_url', '', $_candidate_id, $_job_id) ?>" class="preview-candidate-profile" download="<?php echo apply_filters('jobsearch_user_attach_cv_file_title', '', $_candidate_id, $_job_id) ?>"><i class="fa fa-download"></i> <?php esc_html_e('Download CV', 'wp-jobsearch') ?></a></li>
                                                <?php
                                            }
                                            ...
                                            ?>
                                            <li><a href="<?php echo ($file_url) ?>" class="preview-candidate-profile" download="<?php echo ($cv_file_title) ?>"><i class="fa fa-download"></i> <?php esc_html_e('Download CV', 'wp-jobsearch') ?></a></li>
                                            <?php
                                        }
                        ...
                        <div class="thjob-title">
                            ...
                            <div class="total-appcreds-con">
                                <ul>
                                    ...
                                    <li><div class="applicnt-count-box res-apps"><span><?php esc_html_e('Reserved Applicants: ', 'wp-jobsearch') ?></span> <?php echo absint($job_reserved_int_list_c) ?></div></li>
        ...
        public function alljobs_apps_count_loadboxes() {
            ...
            echo json_encode(array('appcounts' => $appcounts, 'shappcounts' => $shappcounts, 'rejappcounts' => $rejappcounts, 'resappcounts' => $rejappcounts));
