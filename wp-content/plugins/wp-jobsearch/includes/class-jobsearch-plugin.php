...
class JobSearch_plugin {
    ...
    public function menu_order($menu_order) {
        ...
        foreach ($menu_order as $index => $item) {
            ...
            if ('edit.php?post_type=job' === $item) {
                ...
                $jobsearch_menu_order[] = 'jobsearch-applicants-list';
                $jobsearch_menu_order[] = 'edit.php?post_type=employer';
                $jobsearch_menu_order[] = 'edit.php?post_type=candidate';
                $jobsearch_menu_order[] = 'jobsearch-job-fields';
                $jobsearch_menu_order[] = 'jobsearch-email-templates-fields';
                $jobsearch_menu_order[] = 'jobsearch-location-sett';
                $jobsearch_menu_order[] = 'edit.php?post_type=package';
                $jobsearch_menu_order[] = 'jobsearch_options';
                //
    ...
    private function load_dependencies() {
        ...
        //reject module
	    include plugin_dir_path(dirname(__FILE__)) . 'modules/reject/reject.php';
	    //already apply module
	    include plugin_dir_path(dirname(__FILE__)) . 'modules/aplicatdeja/apideja.php';
