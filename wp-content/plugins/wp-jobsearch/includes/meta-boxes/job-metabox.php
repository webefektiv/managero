...
function jobsearch_jobs_meta_settings() {
    ...
    <div class="jobsearch-post-settings">
        ...
        http://managero.ro/wp-login.php?action=logout&redirect_to=http%3A%2F%2Fmanagero.ro%2F&_wpnonce=fe117bdd65
        ...
        if (isset($job_apply_switch) && $job_apply_switch == 'on') {
            ...
            if ($internal_flag) {
                $apply_type_options['internal'] = esc_html__('Managero', 'wp-jobsearch');
            }
           if ($external_flag) {
        ...
        <div class="jobsearch-elem-heading" style="display: none">
            <h2><?php esc_html_e('Add Atachment', 'wp-jobsearch') ?></h2>
        </div>
        <div class="jobsearch-element-field" style="display: none">
            <?php
            $job_id = $post->ID;
                ...
                <div class="jobsearch-element-field">
                    ...
                    <div class="elem-field">
                        <div class="jobsearch-fileUpload">
                            <input id="job_attach_files" name="job_attach_files[]" type="button" class="upload jobsearch-upload" value="Attach Files"/>
                        </div>
        ...
        if (!empty($job_applicants_list)) {
            ...
            ?>
            <div class="jobsearch-elem-heading">
                <h2><?php esc_html_e('Candidati', 'wp-jobsearch') ?></h2>
            </div>
            <?php
            ...
            <div class="jobsearch-applicants-tabs">
                ...
                <ul class="tabs-list">
                    ...
                    <li <?php echo ($_mod_tab == 'shortlisted' ? 'class="active"' : '') ?>><a href="<?php echo add_query_arg(array('tab' => 'manage-jobs', 'view' => 'applicants', 'job_id' => $_job_id, 'mod' => 'shortlisted'), $page_url) ?>"><?php printf(esc_html__('Rezerve (%s)', 'wp-jobsearch'), $job_reserved_int_list_c) ?></a></li>
                ...
                } else if ($_mod_tab == 'reserved') {
                    $job_applicants_list = jobsearch_job_applicants_sort_list($_job_id, $_sort_selected, '_job_reserved_interview_list');
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
		                                                            ...
		                                                            if (in_array($_candidate_id, $job_reserved_int_list)) {
			                                                            ?>
                                                                        <a href="javascript:void(0);" class="reserved-cand-to-intrview"><?php esc_html_e('Candidat rezervat', 'wp-jobsearch') ?></a>
			                                                            <?php
		                                                            } else {
			                                                            ?>
                                                                        <a href="javascript:void(0);" class="reserved-cand-to-intrview ajax-enable" data-jid="<?php echo absint($_job_id); ?>" data-cid="<?php echo absint($_candidate_id); ?>"><?php esc_html_e('Adauga la rezerve', 'wp-jobsearch') ?> <span class="app-loader"></span></a>
			                                                            <?php
		                                                            }
		                                                            ?>
                                                                </li>
