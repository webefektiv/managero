    ...
    <form id="employer-profilesetings-form" class="jobsearch-employer-dasboard" method="post"
        ...
        <div class="jobsearch-employer-box-section">
            ...
            <div class="jobsearch-profile-title">
                <h2><?php esc_html_e( 'Basic Information', 'wp-jobsearch' ) ?></h2>
            </div>
			<?php
			...
			ob_start();
			?>
            <div class="jobsearch-employer-cvr-img" style="display: none;">
                ...
                <figure>
                    <div class="img-cont-sec"
                        ...
                        <a href="javascript:void(0);" class="employer-remove-coverimg"><i
                                    class="fa fa-times"></i> <?php esc_html_e( 'Delete Cover', 'wp-jobsearch' ) ?></a>
            ...
            <ul class="jobsearch-row jobsearch-employer-profile-form">
				...
				<?php
				$field_html = ob_get_clean();
				echo apply_filters( 'jobsearch_empdash_profile_tab_emailfield_html', $field_html, $user_displayname );
                ...
                <li class="jobsearch-column-12" style="display: none;">
                    ...
                    <div class="jobsearch-userprofile-url">
                        ...
                        <input type="text" class="profile-slug-field" style="display: none;" name="user_profile_slug"
                               value="<?php echo urldecode( $user_profile_url ) ?>">
				...
				if ( $emp_phone_switch == 'on' ) {
                    ...
                    <li class="jobsearch-column-6">
                        ...
                        <input value="<?php echo( $user_phone ) ?>"
                               onkeyup="javascript:jobsearch_is_valid_phone_number(this)" type="text" name="user_phone">
                    </li>
					<?php
				}
				ob_start();
                ...
                <!--                editor wordpress call in front-->
		...
		<?php
		//  die();
		echo apply_filters( 'jobsearch_emp_dash_after_generl_info', '', $employer_id );
		?>
		...
		if ( ! empty( $employer_social_mlinks ) || ( $emp_alow_fb_smm == 'on' || $emp_alow_twt_smm == 'on' || $emp_alow_gplus_smm == 'on' || $emp_alow_linkd_smm == 'on' || $emp_alow_dribbb_smm == 'on' ) ) {
			?>
            <div class="jobsearch-employer-box-section">
                <div class="jobsearch-profile-title"><h2><?php esc_html_e( 'Social Links', 'wp-jobsearch' ) ?></h2>
                </div>
                <ul class="jobsearch-row jobsearch-employer-profile-form">
					<?php
					if ( $emp_alow_fb_smm == 'on' ) {
                        ...
                        <li class="jobsearch-column-6">
                            ...
                            <input value="<?php echo( $user_facebook_url ) ?>" name="jobsearch_field_user_facebook_url"
                                   type="text">
                        </li>
						<?php
					}
					if ( $emp_alow_twt_smm == 'on' ) {
                        ...
                        <li class="jobsearch-column-6">
                            ...
                            <input value="<?php echo( $user_twitter_url ) ?>" name="jobsearch_field_user_twitter_url"
                                   type="text">
                        </li>
						<?php
					}
					if ( $emp_alow_gplus_smm == 'on' ) {
                        ...
                        <li class="jobsearch-column-6">
                            ...
                            <input value="<?php echo( $user_google_plus_url ) ?>"
                                   name="jobsearch_field_user_google_plus_url" type="text">
                        </li>
						<?php
					}
					if ( $emp_alow_linkd_smm == 'on' ) {
                        ...
                        <li class="jobsearch-column-6">
                            ...
                            <input value="<?php echo( $user_linkedin_url ) ?>" name="jobsearch_field_user_linkedin_url"
                                   type="text">
                        </li>
						<?php
					}
					if ( $emp_alow_dribbb_smm == 'on' ) {
                        ...
                        <li class="jobsearch-column-6">
                            ...
                            <input value="<?php echo( $user_dribbble_url ) ?>" name="jobsearch_field_user_dribbble_url"
                                   type="text">
                        </li>
						<?php
					}
							...
							foreach ( $employer_social_mlinks['title'] as $field_title_val ) {
								...
								if ( $field_title_val != '' ) {
                                    ...
                                    <li class="jobsearch-column-6">
                                        ...
                                        <input value="<?php echo( $emp_dynm_social ) ?>"
		...
		?>
        <div class="jobsearch-employer-box-section">
            <div class="jobsearch-profile-title"><h2><?php esc_html_e( 'Company Photos/Videos', 'wp-jobsearch' ) ?></h2>
            </div>
                                    ...
                                    <figure>
                                        ...
                                        <figcaption>
                                            <div class="jobsearch-company-links">
                                                ...
                                                <a href="javascript:void(0);"
                                                   class="fa fa-pencil el-update-btn-<?php echo( $rand_id ) ?>"></a>
												<?php
												$popup_args = array(
													'p_gal_counter' => $gal_counter,
													'p_rand_id'     => $rand_id,
													'p_video_url'   => $gal_video_url
												);
												add_action( 'wp_footer', function () use ( $popup_args ) {
                                                    ...
                                                    <div class="jobsearch-modal fade"
                                                         id="JobSearchModalEmployerGallery<?php echo( $p_rand_id ) ?>">
                                                                        ...
                                                                        <ul class="email-fields-list">
                                                                            <li>
                                                                                ...
                                                                                <div class="input-field">
                                                                                    <input type="text"
                                                                                           id="gallery-video-to-get-<?php echo( $p_rand_id ) ?>"
                                                                                           value="<?php echo( $p_video_url ) ?>"/>
                                                                            ...
                                                                            <li>
                                                                                <div class="input-field-submit">
                                                                                    <a href="javascript:void(0);"
                                                                                       id="gallery-update-<?php echo( $p_rand_id ) ?>"
                                                                                       data-id="<?php echo( $p_rand_id ) ?>"
                                                                                       class="careerfy-classic-btn jobsearch-bgcolor"><?php echo esc_html__( 'Update', 'wp-jobsearch' ); ?></a>
                                                                                </div>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
            ...
            <a id="upload-more-gal-imgs" href="javascript:void(0)"
               ...
               style="display: <?php echo( ! empty( $company_gal_imgs ) ? 'block' : 'none' ) ?>;"> <?php esc_html_e( 'Upload More Images', 'wp-jobsearch' ) ?> </a>
        </div>
        ...
        <div class="jobsearch-employer-box-section">
            <div class="jobsearch-candidate-resume-wrap">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <input id="u-post-job-btn" name="u_memb_perms[]"
                                                                   type="checkbox" value="u_post_job" checked="checked">
                                                        ...
                                                        <li>
                                                            <input id="u-pkgs-perms-btn" name="u_memb_perms[]"
                                                                   type="checkbox" value="u_packages" checked="checked">
                ...
                <div class="jobsearch-candidate-title">
                    <h2>
					    <?php esc_html_e( 'Account Members', 'wp-jobsearch' ) ?>
