...
if ( $candidate_id > 0 ) {
    ...
    <div class="jobsearch-employer-box-section">
        <div class="jobsearch-profile-title">
            <h2><?php echo apply_filters( 'jobsearch_cand_dash_favjobs_mainhead_title', esc_html__( 'Joburi pentru aplicat', 'wp-jobsearch' ) ) ?></h2>
        </div>
		<?php
                                    ...
                                    <div class="jobsearch-table-row" data-job="<?= $job_id; ?>">
                                        ...
                                        <div class="jobsearch-table-cell">
                                            <a href="javascript:void(0);"
                                               class="jobsearch-savedjobs-links jobsearch-delete-fav-job"
