...
if ($candidate_id > 0) {
    ...
    <div class="jobsearch-employer-box-sections">
        ...
        <div class="numePreview" style="display: none;">
            <div class="nume"></div>
    ...
    <script>
        ...
        var fieldParticula = jQuery('.acf-field[data-name=particula] input');
        var fieldFormula = jQuery('.acf-field[data-name=formula_adresare] input');
        var fieldTitlu = jQuery('.acf-field[data-name=titlu] input');
      ...
      var nume_complet = titlu + ' ' + prenume + ' ' + particula + ' ' + nume + '(' + formula + ')';

       jQuery('.numePreview .nume').html(nume_complet);
