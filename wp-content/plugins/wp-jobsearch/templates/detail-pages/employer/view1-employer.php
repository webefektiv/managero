                        ...
                        <figcaption>
                            ...
                            <ul class="jobsearch-jobdetail-options">
                                ...
                                if (isset($user_obj->user_url) && $user_obj->user_url != '' && $emp_web_switch == 'on') {
                                    $user_url = apply_filters('jobsearch_employer_info_encoding',$user_obj->user_url);
                                    ob_start();
                                    ?>
                                    <li><i class="jobsearch-icon jobsearch-internet"></i> <a href="<?php echo esc_url($user_url) ?>"><?php echo esc_url($user_url) ?></a></li>
                                    <?php
                                ...
                                if (isset($user_obj->user_email) && $user_obj->user_email != '') {
                                    $user_email = apply_filters('jobsearch_employer_info_encoding',$user_obj->user_email);
                                ...
                                if ($employer_phone != '' && $emp_phone_switch == 'on') {
                                    $user_phone = apply_filters('jobsearch_employer_info_encoding',$employer_phone);
                                    ob_start();
                                    ?>
                                    <li><i class="jobsearch-icon jobsearch-technology"></i> <?php printf(esc_html__('Telephone: %s', 'wp-jobsearch'), $user_phone) ?></li>
                                    <?php
                                        ...
                                        if (isset($employer_social_mlinks['title']) && is_array($employer_social_mlinks['title'])) {
                                            ...
                                            foreach ($employer_social_mlinks['title'] as $field_title_val) {
                                                ...
                                                if ($field_title_val != '' && $emp_dynm_social != '') {
                                                    ?>
                                                    <li><a href="<?php echo ($emp_dynm_social) ?>" <?php echo ($field_icon_styles != '' ? 'style="' . $field_icon_styles . '"' : '') ?> class="<?php echo ($field_icon) ?>"></a></li>
                                                    <?php
                                                }
                                                $field_counter++;
                                            }
