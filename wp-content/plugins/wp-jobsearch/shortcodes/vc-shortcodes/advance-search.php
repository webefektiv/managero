                    ...
                    if ($loc_field == 'show') {
                        if ($all_locations_type != 'api') {
                            ...
                            if ($loc_optionstype == '0' || $loc_optionstype == '1') {
                                ?>
                                <li>
                                    <div id="jobsearch-gdapilocs-contrycon" data-val="<?php echo ($loc_location1) ?>" class="jobsearch-select-style location-level-select">
                                        <select name="location_location1" class="countries<?php echo ($contries_class . $continents_class) ?>" id="countryId">
                            ...
                            <li>
                                ...
                                ?>
                                <div id="jobsearch-gdapilocs-statecon" data-val="<?php echo ($loc_location2) ?>" class="jobsearch-select-style location-level-select">
                                    <select name="location_location2" class="states<?php echo ($states_class) ?>" id="stateId">
                            ...
                            if ($loc_optionstype == '1' || $loc_optionstype == '2') {
                                ?>
                                <li>
                                    <div id="jobsearch-gdapilocs-citycon" data-val="<?php echo ($loc_location3) ?>" class="jobsearch-select-style location-level-select">
                                        <select name="location_location3" class="cities<?php echo ($cities_class) ?>" id="cityId">
