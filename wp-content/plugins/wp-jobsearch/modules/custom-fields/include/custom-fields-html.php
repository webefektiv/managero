...
class Jobsearch_CustomFieldHTML {
            ...
            <div class="field-data" id="heading-field-wraper<?php echo esc_html($rand); ?>" style="display:none;">
                ...
                <div class="input-field">
                    <select name="jobsearch-custom-fields-heading[enable-search][]" >
                        <option <?php if ($heading_field_enable_search == 'no') echo esc_html('selected'); ?> value="no"><?php echo esc_html__('No', 'wp-jobsearch'); ?></option>
                        <option <?php if ($heading_field_enable_search == 'yes') echo esc_html('selected'); ?> value="yes"><?php echo esc_html__('Yes', 'wp-jobsearch'); ?></option>
                    </select>
                </div>
                <label>
                ...
                <div class="input-field">
                    <select name="jobsearch-custom-fields-heading[enable-advsrch][]" >
                        <option <?php if ($heading_field_enable_advsrch == 'no') echo esc_html('selected'); ?> value="no"><?php echo esc_html__('No', 'wp-jobsearch'); ?></option>
                        <option <?php if ($heading_field_enable_advsrch == 'yes') echo esc_html('selected'); ?> value="yes"><?php echo esc_html__('Yes', 'wp-jobsearch'); ?></option>
                    </select>
                </div>
            ...
            <div class="field-data" id="text-field-wraper<?php echo esc_html($rand); ?>" style="display:none;">
                ...
                <div class="input-field">
                    <select name="jobsearch-custom-fields-text[enable-advsrch][]" >
                        <option <?php if ($text_field_enable_advsrch == 'no') echo esc_html('selected'); ?> value="no"><?php echo esc_html__('No', 'wp-jobsearch'); ?></option>
                        <option <?php if ($text_field_enable_advsrch == 'yes') echo esc_html('selected'); ?> value="yes"><?php echo esc_html__('Yes', 'wp-jobsearch'); ?></option>
                    </select>
                </div>
    ...
    static function jobsearch_custom_field_video_html_callback($html, $global_custom_field_counter, $field_data) {
        ...
        <div class="jobsearch-custom-filed-container jobsearch-custom-filed-video-container">
            <div class="field-intro">
                ...
                <a href="javascript:void(0);" class="video-field<?php echo esc_html($rand); ?>" ><?php echo wp_kses(sprintf(__('Video Field %s', 'wp-jobsearch'), $field_dyn_name), array('b' => array())); ?></a>
            </div>
            <?php //var_dump($field_data); ?>
            <div class="field-data" id="video-field-wraper<?php echo esc_html($rand); ?>" style="display:none;">
                ...
                <div class="input-field">
                    <input name="jobsearch-custom-fields-video[label][]" value="<?php echo esc_html($video_field_label); ?>" />
                </div>
                ...
                <div class="input-field">
                    <input class="check-name-availability" name="jobsearch-custom-fields-video[name][]" value="<?php echo esc_html($video_field_name); ?>" />
                    <span class="available-msg"><i class="dashicons dashicons-dismiss"></i></span>
                </div>
                ...
                <div class="input-field">
                    <input name="jobsearch-custom-fields-video[placeholder][]" value="<?php echo esc_html($video_field_placeholder); ?>" />
                </div>
                ...
                <div class="input-field">
                    <input name="jobsearch-custom-fields-video[classes][]" value="<?php echo esc_html($video_field_classes); ?>" />
                </div>
                ...
                <div class="input-field">
                    <select name="jobsearch-custom-fields-video[required][]" >
                        <option <?php if ($video_field_required == 'no') echo esc_html('selected'); ?> value="no"><?php echo esc_html__('No', 'wp-jobsearch'); ?></option>
                        <option <?php if ($video_field_required == 'yes') echo esc_html('selected'); ?> value="yes"><?php echo esc_html__('Yes', 'wp-jobsearch'); ?></option> 
                    </select>
                </div>
    ...
    static function jobsearch_custom_field_linkurl_html_callback($html, $global_custom_field_counter, $field_data) {
        ...
        <div class="jobsearch-custom-filed-container jobsearch-custom-filed-linkurl-container">
            <div class="field-intro">
                ...
                <a href="javascript:void(0);" class="linkurl-field<?php echo esc_html($rand); ?>" ><?php echo wp_kses(sprintf(__('URL Field %s', 'wp-jobsearch'), $field_dyn_name), array('b' => array())); ?></a>
            </div>
            <?php //var_dump($field_data); ?>
            <div class="field-data" id="linkurl-field-wraper<?php echo esc_html($rand); ?>" style="display:none;">
                ...
                <div class="input-field">
                    <input name="jobsearch-custom-fields-linkurl[label][]" value="<?php echo esc_html($linkurl_field_label); ?>" />
                </div>
                ...
                <div class="input-field">
                    <input class="check-name-availability" name="jobsearch-custom-fields-linkurl[name][]" value="<?php echo esc_html($linkurl_field_name); ?>" />
                    <span class="available-msg"><i class="dashicons dashicons-dismiss"></i></span>
                </div>
                ...
                <div class="input-field">
                    <input name="jobsearch-custom-fields-linkurl[placeholder][]" value="<?php echo esc_html($linkurl_field_placeholder); ?>" />
                </div>
                ...
                <div class="input-field">
                    <select name="jobsearch-custom-fields-linkurl[link_target][]" >
                        <option <?php if ($linkurl_field_target == '_self') echo esc_html('selected'); ?> value="_self"><?php echo esc_html__('Self', 'wp-jobsearch'); ?></option>
                        <option <?php if ($linkurl_field_target == '_blank') echo esc_html('selected'); ?> value="_blank"><?php echo esc_html__('Blank', 'wp-jobsearch'); ?></option> 
                    </select>
                </div>
                ...
                <div class="input-field">
                    <input name="jobsearch-custom-fields-linkurl[classes][]" value="<?php echo esc_html($linkurl_field_classes); ?>" />
                </div>
                ...
                <div class="input-field">
                    <select name="jobsearch-custom-fields-linkurl[required][]" >
                        <option <?php if ($linkurl_field_required == 'no') echo esc_html('selected'); ?> value="no"><?php echo esc_html__('No', 'wp-jobsearch'); ?></option>
                        <option <?php if ($linkurl_field_required == 'yes') echo esc_html('selected'); ?> value="yes"><?php echo esc_html__('Yes', 'wp-jobsearch'); ?></option> 
                    </select>
                </div>
    ...
    static function jobsearch_custom_field_upload_html_callback($html, $global_custom_field_counter, $field_data) {
        ...
        <div class="jobsearch-custom-filed-container jobsearch-custom-filed-upload-container">
            <div class="field-intro">
                ...
                <a href="javascript:void(0);" class="upload_file-field<?php echo esc_html($rand); ?>" ><?php echo wp_kses(sprintf(__('Upload File Field %s', 'wp-jobsearch'), $field_dyn_name), array('b' => array())); ?></a>
            </div>
            <?php //var_dump($field_data); ?>
            <div class="field-data" id="upload-field-wraper<?php echo esc_html($rand); ?>" style="display:none;">
                ...
                <div class="input-field">
                    <input name="jobsearch-custom-fields-upload_file[label][]" value="<?php echo esc_html($upload_field_label); ?>" />
                </div>
                ...
                <div class="input-field">
                    <input class="check-name-availability" name="jobsearch-custom-fields-upload_file[name][]" value="<?php echo esc_html($upload_field_name); ?>" />
                    <span class="available-msg"><i class="dashicons dashicons-dismiss"></i></span>
                </div>
                ...
                <div class="input-field">
                    <input name="jobsearch-custom-fields-upload_file[placeholder][]" value="<?php echo esc_html($upload_field_placeholder); ?>" />
                </div>
                ...
                <div class="input-field">
                    <select id="multi-cfield-selct-<?php echo absint($field_counter); ?>" name="jobsearch-custom-fields-upload_file[multi_files][]" >
                        <option <?php if ($upload_field_multifiles == 'no') echo esc_html('selected'); ?> value="no"><?php echo esc_html__('No', 'wp-jobsearch'); ?></option>
                        <option <?php if ($upload_field_multifiles == 'yes') echo esc_html('selected'); ?> value="yes"><?php echo esc_html__('Yes', 'wp-jobsearch'); ?></option> 
                    </select>
                </div>

                <div id="num-fields-holdr-<?php echo absint($field_counter); ?>" class="num_fields_holdr" style="margin-bottom: 15px; display: <?php echo ($upload_field_multifiles == 'yes' ? 'block' : 'none') ?>;">
                    <label>
                        <?php echo esc_html__('Number of Files', 'wp-jobsearch'); ?>:
                    </label>
                    <div class="input-field">
                        <input name="jobsearch-custom-fields-upload_file[numof_files][]" value="<?php echo absint($upload_field_numof_files); ?>" />
                    </div>
                </div>
                ...
                <div class="input-field">
                    <select name="jobsearch-custom-fields-upload_file[allow_types][<?php echo absint($field_counter); ?>][]" multiple="multiple" class="customfield-selectize" placeholder="<?php esc_html_e('Choose File Types', 'wp-jobsearch'); ?>">
                        <option <?php echo (in_array('image/jpeg', $upload_field_allow_types) ? 'selected="selected"' : '') ?> value="image/jpeg"><?php echo esc_html__('jpeg', 'wp-jobsearch'); ?></option>
                        <option <?php echo (in_array('image/png', $upload_field_allow_types) ? 'selected="selected"' : '') ?> value="image/png"><?php echo esc_html__('png', 'wp-jobsearch'); ?></option>
                        <option <?php echo (in_array('text/plain', $upload_field_allow_types) ? 'selected="selected"' : '') ?> value="text/plain"><?php echo esc_html__('text', 'wp-jobsearch'); ?></option>
                        <option <?php echo (in_array('application/msword', $upload_field_allow_types) ? 'selected="selected"' : '') ?> value="application/msword"><?php echo esc_html__('doc', 'wp-jobsearch'); ?></option>
                        <option <?php echo (in_array('application/vnd.openxmlformats-officedocument.wordprocessingml.document', $upload_field_allow_types) ? 'selected="selected"' : '') ?> value="application/vnd.openxmlformats-officedocument.wordprocessingml.document"><?php echo esc_html__('docx', 'wp-jobsearch'); ?></option>
                        <option <?php echo (in_array('application/vnd.ms-excel', $upload_field_allow_types) ? 'selected="selected"' : '') ?> value="application/vnd.ms-excel"><?php echo esc_html__('xls', 'wp-jobsearch'); ?></option>
                        <option <?php echo (in_array('application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', $upload_field_allow_types) ? 'selected="selected"' : '') ?> value="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"><?php echo esc_html__('xlsx', 'wp-jobsearch'); ?></option>
                        <option <?php echo (in_array('application/pdf', $upload_field_allow_types) ? 'selected="selected"' : '') ?> value="application/pdf"><?php echo esc_html__('pdf', 'wp-jobsearch'); ?></option>
                    </select>
                </div>
                ...
                <div class="input-field">
                    <input name="jobsearch-custom-fields-upload_file[file_size][]" value="<?php echo esc_html($upload_field_file_size); ?>" />
                ...
                <div class="input-field">
                    <input name="jobsearch-custom-fields-upload_file[classes][]" value="<?php echo esc_html($upload_field_classes); ?>" />
                </div>
                ...
                <div class="input-field">
                    <select name="jobsearch-custom-fields-upload_file[public_visible][]" >
                        <option <?php if ($upload_field_public_visi == 'yes') echo esc_html('selected'); ?> value="yes"><?php echo esc_html__('Yes', 'wp-jobsearch'); ?></option> 
                        <option <?php if ($upload_field_public_visi == 'no') echo esc_html('selected'); ?> value="no"><?php echo esc_html__('No', 'wp-jobsearch'); ?></option>
                    </select>
                </div>
                ...
                <div class="input-field">
                    <select name="jobsearch-custom-fields-upload_file[required][]" >
                        <option <?php if ($upload_field_required == 'no') echo esc_html('selected'); ?> value="no"><?php echo esc_html__('No', 'wp-jobsearch'); ?></option>
                        <option <?php if ($upload_field_required == 'yes') echo esc_html('selected'); ?> value="yes"><?php echo esc_html__('Yes', 'wp-jobsearch'); ?></option> 
                    </select>
                </div>
            ...
            <div class="field-data" id="email-field-wraper<?php echo esc_html($rand); ?>" style="display:none;">
                ...
                <div class="input-field">
                    <select name="jobsearch-custom-fields-email[enable-advsrch][]" >
                        <option <?php if ($email_field_enable_advsrch == 'no') echo esc_html('selected'); ?> value="no"><?php echo esc_html__('No', 'wp-jobsearch'); ?></option>
                        <option <?php if ($email_field_enable_advsrch == 'yes') echo esc_html('selected'); ?> value="yes"><?php echo esc_html__('Yes', 'wp-jobsearch'); ?></option>
                    </select>
                </div>
            ...
            <div class="field-data" id="number-field-wraper<?php echo esc_html($rand); ?>" style="display:none;">
                ...
                <div class="input-field">
                    <select name="jobsearch-custom-fields-number[enable-advsrch][]" >
                        <option <?php if ($number_field_enable_advsrch == 'no') echo esc_html('selected'); ?> value="no"><?php echo esc_html__('No', 'wp-jobsearch'); ?></option>
                        <option <?php if ($number_field_enable_advsrch == 'yes') echo esc_html('selected'); ?> value="yes"><?php echo esc_html__('Yes', 'wp-jobsearch'); ?></option>
                    </select>
                </div>
            ...
            <div class="field-data" id="date-field-wraper<?php echo esc_html($rand); ?>" style="display:none;">
                ...
                <div class="input-field">
                    <select name="jobsearch-custom-fields-date[enable-advsrch][]" >
                        <option <?php if ($date_field_enable_advsrch == 'no') echo esc_html('selected'); ?> value="no"><?php echo esc_html__('No', 'wp-jobsearch'); ?></option>
                        <option <?php if ($date_field_enable_advsrch == 'yes') echo esc_html('selected'); ?> value="yes"><?php echo esc_html__('Yes', 'wp-jobsearch'); ?></option>
                    </select>
                </div>
            ...
            <div class="field-data" id="range-field-wraper<?php echo esc_html($rand); ?>" style="display:none;">
                ...
                <div class="input-field">
                    <select name="jobsearch-custom-fields-range[enable-advsrch][]" >
                        <option <?php if ($range_field_enable_advsrch == 'no') echo esc_html('selected'); ?> value="no"><?php echo esc_html__('No', 'wp-jobsearch'); ?></option>
                        <option <?php if ($range_field_enable_advsrch == 'yes') echo esc_html('selected'); ?> value="yes"><?php echo esc_html__('Yes', 'wp-jobsearch'); ?></option>
                    </select>
                </div>
            ...
            <div class="field-data" id="salary-field-wraper<?php echo esc_html($rand); ?>" style="display:none;">
                ...
                <div class="input-field">
                    <select name="jobsearch-custom-fields-salary[enable-advsrch][]" >
                        <option <?php if ($salary_field_enable_advsrch == 'no') echo esc_html('selected'); ?> value="no"><?php echo esc_html__('No', 'wp-jobsearch'); ?></option>
                        <option <?php if ($salary_field_enable_advsrch == 'yes') echo esc_html('selected'); ?> value="yes"><?php echo esc_html__('Yes', 'wp-jobsearch'); ?></option>
                    </select>
                </div>
                <label>
                    <?php echo esc_html__('Collapse in Filters', 'wp-jobsearch'); ?>:
    ...
    static function jobsearch_custom_field_dropdown_html_callback($html, $global_custom_field_counter, $field_data) {
        ...
        <div class="jobsearch-custom-filed-container jobsearch-custom-filed-dropdown-container">
            <div class="field-intro">
                ...
                <a href="javascript:void(0);" class="dropdown-field<?php echo esc_html($rand); ?>" ><?php echo wp_kses(sprintf(__('Dropdown Field %s', 'wp-jobsearch'), stripslashes($field_dyn_name)), array('b' => array())); ?></a>
            </div>
            <div class="field-data" id="dropdown-field-wraper<?php echo esc_html($rand); ?>" style="display:none;">
                ...
                <div class="input-field">
                    <input name="jobsearch-custom-fields-dropdown[label][]" value="<?php echo esc_html(stripslashes($dropdown_field_label)); ?>" />
                </div>
                ...
                <div class="input-field">
                    <select name="jobsearch-custom-fields-dropdown[enable-advsrch][]" >
                        <option <?php if ($dropdown_field_enable_advsrch == 'no') echo esc_html('selected'); ?> value="no"><?php echo esc_html__('No', 'wp-jobsearch'); ?></option>
                        <option <?php if ($dropdown_field_enable_advsrch == 'yes') echo esc_html('selected'); ?> value="yes"><?php echo esc_html__('Yes', 'wp-jobsearch'); ?></option>
                    </select>
                </div>
                    ...
                    if (isset($dropdown_field_options['value'])) {
                        ...
                        foreach ($dropdown_field_options['value'] as $option_val) {
                            ...
                            <div class="field-options-list">
                                <input name="jobsearch-custom-fields-dropdown[options][label][<?php echo esc_html($field_counter); ?>][]" value="<?php echo esc_html(stripslashes($option_label)); ?>" placeholder="<?php echo esc_html__('Text', 'wp-jobsearch'); ?>" /> - <input name="jobsearch-custom-fields-dropdown[options][value][<?php echo esc_html($field_counter); ?>][]" value="<?php echo esc_html($option_val); ?>" placeholder="<?php echo esc_html__('Value', 'wp-jobsearch'); ?>" />
    ...
    public static function dependent_dropdown_list_html($dropdown_field_options, $field_counter, $parent_id = '0', $lvel_countr = 1) {
        //var_dump($dropdown_field_options[$parent_id]['label'][$field_counter]);
        if (isset($dropdown_field_options[$parent_id]['label'][$field_counter]) && !empty($dropdown_field_options[$parent_id]['label'][$field_counter]) && is_array($dropdown_field_options[$parent_id]['label'][$field_counter]) && sizeof($dropdown_field_options[$parent_id]['label'][$field_counter]) > 0) {
            $field_vals = isset($dropdown_field_options[$parent_id]['value'][$field_counter]) ? $dropdown_field_options[$parent_id]['value'][$field_counter] : '';
            $field_ids = isset($dropdown_field_options[$parent_id]['id'][$field_counter]) ? $dropdown_field_options[$parent_id]['id'][$field_counter] : '';
            $field_par_ids = isset($dropdown_field_options[$parent_id]['par_id'][$field_counter]) ? $dropdown_field_options[$parent_id]['par_id'][$field_counter] : '';
            
            ob_start();
            $field_count = 0;
            foreach ($dropdown_field_options[$parent_id]['label'][$field_counter] as $opt_field_label) {
                ...
                <div class="dep-drpdwns-fopt levl<?php echo ($lvel_countr) ?>">
                    ...
                    <input type="text" name="jobsearch-custom-fields-dependent_dropdown[options][<?php echo ($parent_id) ?>][label][<?php echo esc_html($field_counter); ?>][]" placeholder="<?php esc_html_e('Option Label', 'wp-jobsearch'); ?>" value="<?php echo ($opt_field_label) ?>"> - <input type="text" name="jobsearch-custom-fields-dependent_dropdown[options][<?php echo ($parent_id) ?>][value][<?php echo esc_html($field_counter); ?>][]" placeholder="<?php esc_html_e('Option Value', 'wp-jobsearch'); ?>" value="<?php echo ($field_val) ?>">
                    <input type="hidden" name="jobsearch-custom-fields-dependent_dropdown[options][<?php echo ($parent_id) ?>][id][<?php echo esc_html($field_counter); ?>][]" value="<?php echo ($optcon_rand) ?>">
                    <input type="hidden" name="jobsearch-custom-fields-dependent_dropdown[options][<?php echo ($parent_id) ?>][par_id][<?php echo esc_html($field_counter); ?>][]" value="<?php echo ($field_par_id) ?>">
                    ...
                    <div class="drpdwns-fopt-acts">
                        ...
                        if ($lvel_countr < 4) {
                            ?>
                            <a href="javascript:void(0);" style="display: <?php echo (!isset($dropdown_field_options[$optcon_rand]) ? 'inline-block' : 'none') ?>;" class="add-depnchild-fieldsec" data-rid="<?php echo ($optcon_rand) ?>"><?php esc_html_e('Add Dependent Fields', 'wp-jobsearch'); ?></a>
                            <?php
                        }
                        ?>
                        <a href="javascript:void(0);" class="deldep-drpdwns-fopt" data-rid="<?php echo ($optcon_rand) ?>"><i class="dashicons dashicons-trash"></i></a>
                    </div>
                </div>
                <?php
                $field_count++;
            ...
            ?>
            <a href="javascript:void(0);" class="add-mor-fieldbtn" data-rid="<?php echo ($optcon_rand) ?>" data-parid="<?php echo ($field_par_id) ?>"><?php esc_html_e('Add More', 'wp-jobsearch'); ?></a>
            <?php
            echo '</div>';
        }
    }
    ...
    static function jobsearch_custom_field_dependent_dropdown_html_callback($html, $global_custom_field_counter, $field_data) {
        ...
        $dropdown_cont_optsid = isset($field_data['options_list_id']) && $field_data['options_list_id'] != '' ? $field_data['options_list_id'] : $field_counter;
        ?>
        <div class="jobsearch-custom-filed-container jobsearch-custom-filed-dependent_dropdown-container">
            <div class="field-intro">
                ...
                <?php $field_dyn_name = $dropdown_field_label != '' ? '<b>(' . $dropdown_field_label . ')</b>' : '' ?>
                <a href="javascript:void(0);" class="dependent_dropdown-field<?php echo esc_html($rand); ?>" ><?php echo wp_kses(sprintf(__('Dependent Dropdown Field %s', 'wp-jobsearch'), stripslashes($field_dyn_name)), array('b' => array())); ?></a>
            </div>
            <div class="field-data" id="dependent_dropdown-field-wraper<?php echo esc_html($rand); ?>" style="display:none;">
                ...
                <div class="input-field">
                    <input name="jobsearch-custom-fields-dependent_dropdown[label][]" value="<?php echo esc_html(stripslashes($dropdown_field_label)); ?>" />
                </div>
                ...
                <div class="input-field">
                    <input class="check-name-availability" name="jobsearch-custom-fields-dependent_dropdown[name][]" value="<?php echo esc_html($dropdown_field_name); ?>" />
                    <span class="available-msg"><i class="dashicons dashicons-dismiss"></i></span>
                </div>
                ...
                <div class="input-field">
                    <input name="jobsearch-custom-fields-dependent_dropdown[placeholder][]" value="<?php echo esc_html($dropdown_field_placeholder); ?>" />
                </div>
                ...
                <div class="input-field">
                    <input name="jobsearch-custom-fields-dependent_dropdown[classes][]" value="<?php echo esc_html($dropdown_field_classes); ?>" />
                </div>
                ...
                <div class="dep-drpdwns-optscon">
                    <input type="hidden" name="jobsearch-custom-fields-dependent_dropdown[options_field_counter_id][]" value="<?php echo ($dropdown_cont_optsid) ?>">
                    <?php
//                    echo '<pre>';
//                    print_r($dropdown_field_options);
//                    echo '</pre>';
                    if (isset($dropdown_field_options[0]['label'][$dropdown_cont_optsid]) && !empty($dropdown_field_options[0]['label'][$dropdown_cont_optsid]) && is_array($dropdown_field_options[0]['label'][$dropdown_cont_optsid]) && sizeof($dropdown_field_options[0]['label'][$dropdown_cont_optsid]) > 0) {
                        //
                        ...
                        <div class="dep-drpdwns-foptss foptslevl1 dep-drpdwns-optscon-<?php echo ($optcon_rand) ?>">
                            <div class="dep-drpdwns-fopt levl1">
                                <a href="javascript:void(0);" class="drp-sort-handle"><i class="dashicons dashicons-image-flip-vertical"></i></a>
                                <input type="text" name="jobsearch-custom-fields-dependent_dropdown[options][0][label][<?php echo esc_html($dropdown_cont_optsid); ?>][]" placeholder="<?php esc_html_e('Option Label', 'wp-jobsearch'); ?>" value=""> - <input type="text" name="jobsearch-custom-fields-dependent_dropdown[options][0][value][<?php echo esc_html($dropdown_cont_optsid); ?>][]" placeholder="<?php esc_html_e('Option Value', 'wp-jobsearch'); ?>" value="">
                                <input type="hidden" name="jobsearch-custom-fields-dependent_dropdown[options][0][id][<?php echo esc_html($dropdown_cont_optsid); ?>][]" value="<?php echo ($optcon_rand) ?>">
                                <input type="hidden" name="jobsearch-custom-fields-dependent_dropdown[options][0][par_id][<?php echo esc_html($dropdown_cont_optsid); ?>][]" value="0">
                                <div id="depnchilds-sec-con-<?php echo ($optcon_rand) ?>"></div>
                                <div class="drpdwns-fopt-acts">
                                    <a href="javascript:void(0);" class="add-depnchild-fieldsec" data-rid="<?php echo ($optcon_rand) ?>"><?php esc_html_e('Add Dependent Fields', 'wp-jobsearch'); ?></a>
                                </div>
                            </div>
                            <a href="javascript:void(0);" class="add-mor-fieldbtn" data-rid="<?php echo ($optcon_rand) ?>" data-parid="0"><?php esc_html_e('Add More', 'wp-jobsearch'); ?></a>
                        </div>
                        <?php
                    }
                    ?>
            ...
            <script>
                ...
                jQuery(document).on('click', '.add-mor-fieldbtn', function () {
                    ...
                    <div class="dep-drpdwns-fopt ' + thisPar_class + '">\
                        <a href="javascript:void(0);" class="drp-sort-handle"><i class="dashicons dashicons-image-flip-vertical"></i></a>\
                        <input type="text" name="jobsearch-custom-fields-dependent_dropdown[options][' + (thisparid) + '][label][<?php echo esc_html($dropdown_cont_optsid); ?>][]" placeholder="<?php esc_html_e('Option Label', 'wp-jobsearch'); ?>"> - <input type="text" name="jobsearch-custom-fields-dependent_dropdown[options][' + (thisparid) + '][value][<?php echo esc_html($dropdown_cont_optsid); ?>][]" placeholder="<?php esc_html_e('Option Value', 'wp-jobsearch'); ?>">\
                        <input type="hidden" name="jobsearch-custom-fields-dependent_dropdown[options][' + (thisparid) + '][id][<?php echo esc_html($dropdown_cont_optsid); ?>][]" value="' + _math_rand + '">\
                        <input type="hidden" name="jobsearch-custom-fields-dependent_dropdown[options][' + (thisparid) + '][par_id][<?php echo esc_html($dropdown_cont_optsid); ?>][]" value="' + (thisPar_class == 'levl1' ? '0' : thisparid) + '">\
                ...
                jQuery(document).on('click', '.add-depnchild-fieldsec', function () {
                    ...
                    <div class="dep-drpdwns-foptss ' + Plevl_Class + ' dep-drpdwns-optscon-' + _math_rand + '">\
                        <div class="dep-drpdwns-fopt ' + Levl_Class + '">\
                            <a href="javascript:void(0);" class="drp-sort-handle"><i class="dashicons dashicons-image-flip-vertical"></i></a>\
                            <input type="text" name="jobsearch-custom-fields-dependent_dropdown[options][' + (thisrid) + '][label][<?php echo esc_html($dropdown_cont_optsid); ?>][]" placeholder="<?php esc_html_e('Option Label', 'wp-jobsearch'); ?>"> - <input type="text" name="jobsearch-custom-fields-dependent_dropdown[options][' + (thisrid) + '][value][<?php echo esc_html($dropdown_cont_optsid); ?>][]" placeholder="<?php esc_html_e('Option Value', 'wp-jobsearch'); ?>">\
                            <input type="hidden" name="jobsearch-custom-fields-dependent_dropdown[options][' + (thisrid) + '][id][<?php echo esc_html($dropdown_cont_optsid); ?>][]" value="' + _math_rand + '">\
                            <input type="hidden" name="jobsearch-custom-fields-dependent_dropdown[options][' + (thisrid) + '][par_id][<?php echo esc_html($dropdown_cont_optsid); ?>][]" value="' + (Levl_Class == 'levl1' ? '0' : thisrid) + '">\
                            <div id="depnchilds-sec-con-' + _math_rand + '"></div>\
                            <div class="drpdwns-fopt-acts">\
                                ' + add_depfield_btn + '\
                                ' + trash_depfield_btn + '\
            ...
            <div class="field-data" id="textarea-field-wraper<?php echo esc_html($rand); ?>" style="display:none;">
                ...
                <div class="input-field">
                    <select name="jobsearch-custom-fields-textarea[media_buttons][]" >
                        <option <?php if ($textarea_field_media_btns == 'yes') echo esc_html('selected'); ?> value="yes"><?php echo esc_html__('Yes', 'wp-jobsearch'); ?></option> 
                        <option <?php if ($textarea_field_media_btns == 'no') echo esc_html('selected'); ?> value="no"><?php echo esc_html__('No', 'wp-jobsearch'); ?></option>
                    </select>
                </div>
                ...
                <div class="input-field">
                    <select name="jobsearch-custom-fields-textarea[enable-advsrch][]" >
                        <option <?php if ($textarea_field_enable_advsrch == 'no') echo esc_html('selected'); ?> value="no"><?php echo esc_html__('No', 'wp-jobsearch'); ?></option>
                        <option <?php if ($textarea_field_enable_advsrch == 'yes') echo esc_html('selected'); ?> value="yes"><?php echo esc_html__('Yes', 'wp-jobsearch'); ?></option>
                    </select>
                </div>
