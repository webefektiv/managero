    ...
    class Redux_Framework_options_config {
        ...
        public function setSections() {
            ...
            $sec_array[] = array(
                ...
                'title' => __('Salary', 'wp-jobsearch'),
                'subtitle' => '',
                'desc' => __('It will disable/enable the salary fields in all job views.', 'wp-jobsearch'),
                'options' => array(
                    'on' => __('On', 'wp-jobsearch'),
                    'off' => __('Off', 'wp-jobsearch'),
                ),
            ...
            $cand_dashbord_sett[] = array(
                ...
                'subtitle' => '',
                'desc' => __('Set candidate approval method after registeration.', 'wp-jobsearch'),
                'options' => array(
...
Your membership account is awaiting approval by the site administrator. You will not be able to fully interact with the account functions and aspects of this website until your account is approved. Once approved by admin or denied you will receive an email notice.',
            ...
            $cand_dashbord_sett[] = array(
                ...
                'title' => __('Salary', 'wp-jobsearch'),
                'subtitle' => '',
                'desc' => __('It will disable/enable the salary fields in all candidate section.', 'wp-jobsearch'),
                'options' => array(
                    'on' => __('On', 'wp-jobsearch'),
                    'off' => __('Off', 'wp-jobsearch'),
                ),
            ...
            $cand_dashbord_sett[] = array(
                ...
                'subtitle' => '',
                'desc' => __('It will disable/enable the Date of Birth fields in all candidate section.', 'wp-jobsearch'),
                'options' => array(
                    'on' => __('On', 'wp-jobsearch'),
                    'off' => __('Off', 'wp-jobsearch'),
                ),
            ...
            $cand_dashbord_sett[] = array(
                ...
                'type' => 'sortable',
                'title' => __('Dashboard Menu', 'wp-jobsearch'),
                'subtitle' => __('Enable/Disable and reorder candidate dashboard menu items however you want.', 'wp-jobsearch'),
                'desc' => '',
                'mode' => 'checkbox',
                'options' => apply_filters('jobsearch_cand_dash_menu_in_opts', array(
                    ...
                    'fav_jobs' => __('Favourite Jobs', 'wp-jobsearch'),
            ...
            $cand_dashbord_sett[] = array(
                'id' => 'cand_alow_gplus_smm',
                'type' => 'button_set',
                'title' => __('Google Plus', 'wp-jobsearch'),
                'subtitle' => '',
                'desc' => '',
                'options' => array(
                    'on' => __('On', 'wp-jobsearch'),
            ...
            $cand_dashbord_sett[] = array(
                ...
                'subtitle' => '',
                'desc' => __('Add more Social Media platforms for candidate.', 'wp-jobsearch'),
                'default' => '',
            );
            $cand_dashbord_sett[] = array(
            ...
            $emp_dashbord_sett[] = array(
                ...
                'subtitle' => '',
                'desc' => __('Set employers approval method after registeration.', 'wp-jobsearch'),
                'options' => array(
                    'on' => __('Auto', 'wp-jobsearch'),
                    'off' => __('Admin Review', 'wp-jobsearch'),
                    'email' => __('Auto with Email', 'wp-jobsearch'),
            ...
            $emp_dashbord_sett[] = array(
                ...
                'type' => 'sortable',
                'title' => __('Dashboard Menu', 'wp-jobsearch'),
                'subtitle' => __('Enable/Disable and reorder employer dashboard menu items however you want.', 'wp-jobsearch'),
                'desc' => '',
                'mode' => 'checkbox',
                'options' => apply_filters('jobsearch_emp_dash_menu_in_opts', array(
            ...
            $emp_dashbord_sett[] = array(
                ...
                'title' => __('Other Social Links', 'wp-jobsearch'),
                'subtitle' => '',
                'desc' => __('Add more Social Media platforms for employer.', 'wp-jobsearch'),
                'default' => '',
            );
            $emp_dashbord_sett[] = array(
            ...
            $employer_arr[] = array(
                ...
                'subtitle' => __('Warning! It will change all employers URL.', 'wp-jobsearch'),
            ...
            $employer_arr[] = array(
                'id' => 'emp-sensinfo-for',
                'type' => 'button_set',
                'title' => __('Show Employers Info for', 'wp-jobsearch'),
                'subtitle' => '',
                'desc' => __('Show Employers Info such as employer\'s phone, email address or website url for login or non-login users.', 'wp-jobsearch'),
                'options' => array(
            ...
            $candidate_arr[] = array(
                ...
                'subtitle' => __('Warning! It will change all candidates URL.', 'wp-jobsearch'),
                'desc' => sprintf(__('<strong>Please save <a href="%s" target="_blank">permalinks</a> after change this slug.</strong>', 'wp-jobsearch'), admin_url('options-permalink.php')),
                'default' => 'candidate',
            );
            $candidate_arr[] = array(
            ...
            $woutlogin_aply_array[] = array(
                ...
                'required' => array('job-apply-without-login', 'equals', 'on'),
                'subtitle' => __('Enable Custom Fields in apply job without login form.', 'wp-jobsearch'),
                'desc' => '',
                'options' => array(
                    'on' => __('On', 'wp-jobsearch'),
                    'off' => __('Off', 'wp-jobsearch'),
            ...
            $job_settings = apply_filters('job_detail_pages_styles', $job_settings);
            ...
            $job_settings[] = array(
                ...
                'subtitle' => '',
                'desc' => __('If this switch is "on" then only approved employer\'s jobs will show in listing.', 'wp-jobsearch'),
                'options' => array(
                    'on' => __('On', 'wp-jobsearch'),
                    'off' => __('Off', 'wp-jobsearch'),
                ),
            ...
            $section_settings = array(
                ...
                'fields' => apply_filters('jobsearch_poptions_post_job_sett_fields', array(
                    ...
                    array(
                        'id' => 'job-apply-switch',
                        'type' => 'button_set',
                        'title' => __('Candidate Apply job', 'wp-jobsearch'),
                        'subtitle' => '',
                        'desc' => __('Allow users to apply job with different methods', 'wp-jobsearch'),
                        'options' => array(
                            'on' => __('On', 'wp-jobsearch'),
                            'off' => __('Off', 'wp-jobsearch'),
                        ),
